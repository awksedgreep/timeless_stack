defmodule TimelessStack.MixProject do
  ...
  defp deps do
    [
      {:timeless_metrics, github: "awksedgreep/timeless_metrics", tag: "v3.0.6"},
      {:timeless_logs, github: "awksedgreep/timeless_logs", tag: "v1.0.5"},
      {:timeless_traces, github: "awksedgreep/timeless_traces", tag: "v1.0.4"},
